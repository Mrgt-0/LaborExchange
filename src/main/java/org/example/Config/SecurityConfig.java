    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("users/profile", "/vacancies", "/vacancies").authenticated()
                        .requestMatchers("/vacancies/addVacancy", "/vacancies/delete-vacancy", "/vacancies/editVacancy").hasRole("EMPLOYER")
